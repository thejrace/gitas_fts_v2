...
public class Yon_Tayini {

    public static int GIDIS = 0, DONUS = 1, RING = 2;
    ...
    public static int yap(String hat, int aktif_sefer_index, ArrayList<String> guzergahlar) {
        ...
        int aktif_sefer_yon = guzergah_orta_harf_al(hat_length, aktif_sefer);
        int sonraki_sefer_yon = guzergah_orta_harf_al(hat_length, sonraki);
        int onceki_sefer_yon = guzergah_orta_harf_al(hat_length, onceki);
			...
			*/
            ...
            if (aktif_sefer_yon == sonraki_sefer_yon) {
				...
				*/
                ...
                if (guzergah_orta_harf_al(hat_length, guzergahlar.get(aktif_sefer_index + 2)) == sonraki_sefer_yon) {
					/*
